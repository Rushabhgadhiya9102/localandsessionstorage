...
const LocalStorage = () => {
  ...
  useEffect(() => {
    let newData = JSON.parse(localStorage.getItem("review")) || [];
  ...
  const handleSubmit = (e) => {
    ...
    if (editId === null) {
      ...
      btnColor.current.classList.add("btn-primary");
  ...
  const handleDelete = (id) => {
    ...
    localStorage.setItem("review", JSON.stringify(removeData));
  ...
  const handleEdit = (id) => {
    ...
    btnColor.current.classList.remove("btn-primary");
  ...
  return (
    <>
      <section className="form-section my-5">
        ...
        >
          <div className="title">
            <h2 className="text-primary fw-bold fs-4">Local Storage</h2>
          </div>
          ...
          {/* ------------ F O R M - L E F T - S E C T I O N ------------- */}
                    ...
                    ...Array(5)
                      ...
                      .map((_, index) => (
                        <FaStar
                          ...
                          key={index}
                          color={
                            hover > index || star > index ? "#0d6efd" : "gray"
                          }
            ...
            <div className="col-lg-6">
              ...
              <div className="form-right-item">
                ...
                <button
                  className="btn btn-primary icon-link icon-link-hover "
                  ref={btnColor}
                >
      ...
      <section className="data-section py-5">
        <div className="container">
          <div className="title mb-5">
            <h2 className="fs-1 fw-bold">Reviews <span className="text-primary">Data</span></h2>
          </div>
